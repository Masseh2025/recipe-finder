    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-neutral-0 border-b border-neutral-200">
        <div className="max-w-6xl mx-auto px-5 py-4 sm:px-10 flex items-center justify-between gap-6">
          <Link href="/" className="flex items-center gap-2 shrink-0" aria-label="Healthy Recipe Finder home">
            <span className="relative w-8 h-8 rounded-full bg-teal-500 flex items-center justify-center">
              <span className="absolute w-3 h-3 rounded-full bg-orange-500 top-0.5 right-0.5" aria-hidden />
            </span>
            <span className="font-(family-name:--font-nunito) font-bold text-lg text-neutral-900">
          ...
          <nav className="flex items-center gap-8" aria-label="Main">
            ...
            <Link
              href="/about"
              className="text-neutral-900 font-semibold border-b-2 border-orange-500 pb-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 rounded"
            >
              About
            </Link>
            <Link
      ...
      <main className="flex-1">
        ...
        <section className="max-w-6xl mx-auto px-5 py-16 sm:px-10 sm:py-20">
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <span className="absolute -bottom-4 -right-4 w-24 h-16 text-teal-500/80" aria-hidden>
                <svg viewBox="0 0 96 64" fill="none" className="w-full h-full">
                  <path d="M0 32 Q24 8 48 32 T96 32" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round" />
                </svg>
              </span>
            </div>
          </div>
              ...
              {[
                ...
                <li key={item.title} className="flex gap-4">
                  <span className="text-teal-500 mt-1 shrink-0" aria-hidden>
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor" className="rotate-0">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-800 leading-relaxed">{item.body}</p>
                  </div>
                </li>
              ))}
            </ul>
              ...
              <ul className="space-y-3 list-none p-0 m-0">
                {[
                  ...
                  <li key={text} className="flex gap-3 items-start">
                    <span className="w-2 h-2 rounded-full bg-teal-500 mt-2 shrink-0" aria-hidden />
        ...
        {/* CTA */}
        <section className="max-w-6xl mx-auto px-5 py-12 sm:px-10 sm:py-16" aria-labelledby="cta-heading">
          <div className="relative rounded-2xl bg-neutral-200 px-8 py-14 sm:px-14 sm:py-16 text-center overflow-hidden">
            <span className="absolute left-6 top-1/2 -translate-y-1/2 text-neutral-400/60 w-12 h-12" aria-hidden>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-full h-full">
                <path d="M8 4 L8 20 M16 4 L16 20 M4 8 L20 8 M4 16 L20 16" />
              </svg>
            </span>
            <span className="absolute right-6 top-1/2 -translate-y-1/2 text-neutral-400/60 w-10 h-10" aria-hidden>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-full h-full">
                <path d="M4 4 L20 20 M20 4 L4 20" />
              </svg>
            </span>
            <h2 id="cta-heading" className="font-(family-name:--font-nunito) font-extrabold text-3xl sm:text-4xl text-neutral-900 mb-3">
      ...
      <footer className="border-t border-neutral-200 bg-neutral-0 mt-auto">
        <div className="max-w-6xl mx-auto px-5 py-6 sm:px-10 flex flex-wrap items-center justify-between gap-4">
          <p className="text-neutral-800 text-sm">
            Made with <span aria-label="love">❤️</span> and <span aria-label="sparkle">✨</span>
          </p>
          <div className="flex items-center gap-5" aria-label="Social links">
            <a href="https://instagram.com" className="text-neutral-800 hover:text-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://twitter.com" className="text-neutral-800 hover:text-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://pinterest.com" className="text-neutral-800 hover:text-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded" target="_blank" rel="noopener noreferrer">
              <span className="sr-only">Pinterest</span>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M12 0C5.373 0 0 5.372 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738.098.119.112.224.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.233 7.464-1.214 0-2.354-.629-2.758-1.379l-.749 2.848c-.269 1.045-1.004 2.352-1.498 3.146 1.123.345 2.306.535 3.55.535 6.627 0 12-5.373 12-12 0-6.628-5.373-12-12-12z"/></svg>
            </a>
            <a href="https://tiktok.com" className="text-neutral-800 hover:text-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded" target="_blank" rel="noopener noreferrer">
